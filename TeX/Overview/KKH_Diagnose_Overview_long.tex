...
\caption{Robustness with respect to Inclusion of \texttt{fixed effects} and \texttt{covariates}} % caption
...
\begin{threeparttable}
\centering % center the tabular
\caption{Robustness with respect to the choice of \texttt{control group}} % caption
\label{table 1} % label to refer to it in the text
\input{D_5}
\begin{tablenotes}
    \item \scriptsize 
