...
%\input{parts/mlch_revision_reply_letter1} 
\input{parts/mlch_revision_reply_editor_R2}	
%\input{parts/mlch_revision_reply_reviewer1}	
%\input{parts/mlch_revision_reply_reviewer2}		
...
\input{parts/mlch_appendix_validity}
...
\setcounter{table}{0} 
\singlespacing
\input{parts/mlch_appendix_figures}
\onehalfspacing
...
\input{parts/mlch_appendix_tables}
