...
\begin{landscape}
	...
	\begin{figure}[H]\centering
		...
		\scriptsize
		\begin{minipage}{\linewidth}
			\emph{Notes:} \revision{The top panels show pre-threshold (born November-April) means for the treatment (1978/79) and control cohort (1977/78) across the years. The bottom panels plot DiD estimates (along with 90\% and 95\% confidence intervals) for the impact of the reform on hospital admission over the life-course. The outcomes are defined as the number of cases per 1,000 individuals. Column a shows the results for all admissions, whereas columns b and c show the estimates for females and males, respectively.}
		\end{minipage}
	\end{figure}
	\vspace*{\fill}\clearpage
\end{landscape}
...
\begin{landscape}
	...
	\begin{figure}[H]\centering
		...
		\scriptsize
		\begin{minipage}{\linewidth}
			\emph{Notes:} \revision{The top panels show pre-threshold (born November-April) means for the treatment (1978/79) and control cohort (1977/78) across the years. The bottom panels plot DiD estimates (along with 90\% and 95\% confidence intervals) for the impact of the reform on mental and behavioral disorders over the life-course. The outcomes are defined as the number of cases per 1,000 individuals. Column a shows the results for all admissions, whereas columns b and c show the estimates for females and males, respectively.}
		\end{minipage}
	\end{figure}
	\vspace*{\fill}\clearpage
\end{landscape}
