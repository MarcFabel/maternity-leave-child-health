...
% figure: school_entry cutoffs different bandwidths
\begin{landscape}
	\vspace*{\fill}
	\begin{figure}[H]\centering\caption{xxx}\label{fig_mlch: hospital2_school_cutoff}
		\includegraphics[width=0.9\linewidth]{paper/hospital2_school_entry_small_bw_overview.pdf}
	\end{figure}
	\scriptsize
	\begin{minipage}{0.9\linewidth}
		\emph{Notes:}.
...
\begin{landscape}
	...
	\begin{figure}[H]\centering\caption{xxx}\label{fig_mlch: add_cg}
		\includegraphics[width=0.9\linewidth]{paper/hospital2_addcg_different_bws_overview.pdf}
	\end{figure}
	\scriptsize
	\begin{minipage}{0.9\linewidth}
		\emph{Notes:}.
