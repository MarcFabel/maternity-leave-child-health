...
\end{quote}
\underline{Response:}
page \pageref{rev_mlch: ed_literature_income_childhealth}
Literature on the effect of income on children's health -> 
\cite{milligan2011taxbenefits}, \cite{aizer2016cash-transfer} , \cite{akee2018income}
