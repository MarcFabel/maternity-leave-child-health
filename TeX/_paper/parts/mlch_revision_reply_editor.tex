...
Below is a summary of how I have revised the paper based on the comments made by the editor and the two reviewers. I follow the sequence in which the issues were raised and include the respective comment (in italics and indented) before my response.
