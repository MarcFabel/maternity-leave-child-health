...
\input{mlch_fig__hospitaladmission.tex}
...
\input{paper/DD_hospital2_overall_agegroup_total}
...
\afterpage{
\input{paper/DD_hospital2_overall_agegroup_women_men}
} 
 
% Fig - life-course hospital2
\input{mlch_fig__life-course_hospital2.tex}
...
\afterpage{
\input{mlch_fig__DD_chapters}
\input{../../analysis/tables/paper/DD_overview_chapters}
}
...
% fig - life-course d5
\input{mlch_fig__life-course_d5}
% fig over subcategories MBD
\input{mlch_fig__DD_d5_subcategories}
}
...
\input{paper/subgroup_analysis_rural_urban}
