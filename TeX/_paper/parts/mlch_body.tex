...
% Roadmap
The remainder of the paper is structured as follows. The next section provides information about the 1979 ML reform. Section \ref{sec_mlch:framework} contains a description of the conceptual framework. Section \ref{sec_mlch:data} explains the data and variables. Section \ref{sec_mlch:empirical_strategy} discusses the empirical design. Section \ref{sec_mlch:results} reports results. Section \ref{sec_mlch:discussion} contains a discussion of mechanisms and Section \ref{sec_mlch:conclusion} concludes.
%\vspace*{\fill}
...
%-------------------------------------------------------------------
\bigskip
\section[Framework]{Conceptual Framework for Long-Run Health Effects}\label{sec_mlch:framework}
...
A discussion of potential mechanisms through which the 1979 ML reform might have affected child health outcomes can be found in section \ref{sec_mlch:discussion}.
...
%-------------------------------------------------------------------
\bigskip
\section[Discussion]{Discussion of potential mechanisms}\label{sec_mlch:discussion}
