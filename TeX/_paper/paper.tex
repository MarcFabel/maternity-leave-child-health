% 	TO DO: 
%	EINFÜGEN VON HISTORISCHEN BILDERN, MZ UND FERTILITY GRAPHEN
...
\begin{landscape}
	\begin{figure}
		[H]\centering
		\caption{Reduced form for hospital admission}\label{fig: rf_hospital2}
		\includegraphics[width=0.85\linewidth]{paper/rd_r_fert_hospital2_overview_agegroups.pdf}
			\scriptsize
			\begin{minipage}{0.9\linewidth}
				\emph{Notes:} The figure plots the number of diagnoses per 1,000 individuals for month-of-birth cohorts born half a year around the cut-off date of the 1979 maternity leave expansion across gender and different age groups. The first column reports the ratios for all patients, and the second and third column do so for women and men, respectively. The rows show the ratios across different age groups. The dashed lines represent fitted values from a linear regression of
				the number of diagnoses per 1,000 individuals on month-of-birth. The solid vertical red line divides the pre- and post-reform schemes (two vs. six months of leave).\newline
...
\begin{landscape}
	\begin{figure}
		[H]\centering
		\caption{Reduced form for mental \& behavioral disorders}\label{fig: rf_d5}
		\includegraphics[width=0.85\linewidth]{paper/rd_r_fert_d5_overview_agegroups.pdf}
		\scriptsize
		\begin{minipage}{0.9\linewidth}
		\emph{Notes:} The figure plots the number of diagnoses per 1,000 individuals for month-of-birth cohorts born half a year around the cut-off date of the 1979 maternity leave expansion across gender and different age groups. The first column reports the ratios for all patients, and the second and third column do so for women and men, respectively. The rows show the ratios across different age groups. The dashed lines represent fitted values from a linear regression of
		the number of diagnoses per 1,000 individuals on month-of-birth. The solid vertical red line divides the pre- and post-reform schemes (two vs. six months of leave).\newline
...
\vspace*{\fill}\clearpage
%--------------------------------------------
% LC Approach D5 (Mental and behavioral disod)
\vspace*{\fill}
\begin{figure}[H]\centering
...
\begin{figure}[H]\centering
	...
	\includegraphics[width=0.8\linewidth]{../../analysis/graphs/presentation/d5partition.pdf}
	\scriptsize
	\begin{minipage}{0.9\linewidth}
...
% Difference in Difference tables for HOSPITAL 
\newpage
\input{../../analysis/tables/paper/DD_hospital2_total_agegroup_total}
\input{../../analysis/tables/paper/DD_hospital2_total_agegroup_women}
\input{../../analysis/tables/paper/DD_hospital2_total_agegroup_men}
%--------------------------------------------
