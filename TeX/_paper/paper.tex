...
\cite{Dustmann2012} show that many mothers strongly adjust their labor supply downwards during the four months of extra leave, and return to the labor market shortly after the leave period terminated. Yet, it seems that there is only a negligible effect on long-run maternal labor supply (i.e. for the time period beyond six months after childbirth). Difference-in-difference estimates reveal that mothers postpone their return to work by on average 0.835 months. Another  
