...
backend=biber,
maxcitenames=2, % maximum number of names to appear in citations before switching to et al.
maxbibnames=10, % maximum number of names to appear in the bibliography before switching to et al.
block=space, % "Blocksatz" of the bibliography
...
\setlength{\bibitemsep}{0.5em} % set vertical space between entries
\setlength{\bibhang}{3em}  % set hanging indent after first line of an entry
%\setlength\bibhang{3\parindent}
%\setlength{\bibitemsep}{0.5\baselineskip}

% no In: Journal appears
\renewbibmacro{in:}{}

% comma after publication year
\renewcommand{\labelnamepunct}{\addcomma\space} 

\finalandcomma % put a comma in front of the final and in a list of authors

% issue in parentheses after number
\usepackage{xpatch}

% no fullstop before number of articles
...
% line breaks for very long urls
...
%% no pp. in front of page numbers
%\DeclareFieldFormat{pages}{{\nopp#1}}
%\DefineBibliographyStrings{american}{pages={}}
...
% length of dash for entries of the same authors
%\renewcommand*\bibnamedash{\rule[0.48ex]{3em}{0.14ex}\space}
\addbibresource{../Bib_Masterarbeit-new.bib}
...
%\setlength\evensidemargin{0.1in}
 ...
 \hypersetup{
     ...
     citecolor    = darkblue,
 	linkcolor= darkblue,
     urlcolor=darkblue } % macht die URLS blau
...
% BACKGROUND
%--------------------------------------------------------------------
\section{Background on the 1979 maternity leave reform}
\subsection{reform}
  \begin{itemize}
    \item description 
    \item eligibility
...
In particular, our baseline approach to estimating the effect of the length of maternity leave 

college football game days on the number of daily rape reports corresponds to the following equation
We estimate
\begin{align}
...
% DATA & VARIABLES
%--------------------------------------------------------------------
\section{Hospital registry data}
