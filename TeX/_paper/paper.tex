...
\author{{\color{red}Preliminary and incomplete draft\newline Please do not cite or circulate without the authors' persmission.}\\ \\
...
\begin{itemize}
  ...
  \end{itemize}
  \item Spill-over of labour market policy on health outcomes
\end{itemize}
