...
% TABLES
%--------------------------------------------------------------------
\input{KKH/paper_hospital2_DD_maintable.tex}
...
\begin{threeparttable} \centering \caption{ITT effects on \textbf{hospital admission (total)}}\label{tab: DD_hopsital2_total}
 {\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} 
	\begin{tabular}{l*{5}{c}}
		...
		\input{KKH/paper_hospital2_DD_overall} \\ \\
		\multicolumn{5}{l}{\emph{Panel B. Age brackets}} \\
		\input{KKH/paper_hospital2_DD_17-21} \input{KKH/paper_hospital2_DD_22-26} \input{KKH/paper_hospital2_DD_27-31} \input{KKH/paper_hospital2_DD_32-35} 
		\bottomrule 
	\end{tabular}}
	\begin{tablenotes} 
...
\begin{table}[H] \centering 
	\begin{threeparttable} \centering \caption{ITT effects on \textbf{hospital admission (women)}}\label{tab: DD_hopsital2_female} {\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} 
			\begin{tabular}{l*{5}{c}}
				...
				\midrule
				\multicolumn{5}{l}{\emph{Panel A.Over entire length of the life-course}} \\
				\input{KKH/paper_hospital2_f_DD_overall} \\ \\
				\multicolumn{5}{l}{\emph{Panel B. Age brackets}} \\
				\input{KKH/paper_hospital2_f_DD_17-21} \input{KKH/paper_hospital2_f_DD_22-26} \input{KKH/paper_hospital2_f_DD_27-31} \input{KKH/paper_hospital2_f_DD_32-35} 
				\bottomrule 
		\end{tabular}}
		\begin{tablenotes} 
			\item \scriptsize \emph{Notes:} Clustered standard errors in parentheses. All regression are run with CG2 (i.e. the cohort prior to the reform) and with month-of-birth FEs. The 'overall' specification includes year fixed effects, as well. The outcome variables are defined as the number of cases per thousand individuals (births). Dependent mean and the effect size correspond to pre-reform values of the treated group.
...
\begin{table}[H] \centering 
	\begin{threeparttable} \centering \caption{ITT effects on \textbf{hospital admission (men)}}\label{tab: DD_hopsital2_male} {\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} 
			\begin{tabular}{l*{5}{c}}
				...
				\midrule
				\multicolumn{5}{l}{\emph{Panel A. Over entire length of the life-course}} \\
				\input{KKH/paper_hospital2_m_DD_overall} \\ \\
				\multicolumn{5}{l}{\emph{Panel B. Age brackets}} \\
				\input{KKH/paper_hospital2_m_DD_17-21} \input{KKH/paper_hospital2_m_DD_22-26} \input{KKH/paper_hospital2_m_DD_27-31} \input{KKH/paper_hospital2_m_DD_32-35} 
				\bottomrule 
		\end{tabular}}
		\begin{tablenotes} 
			\item \scriptsize \emph{Notes:} Clustered standard errors in parentheses. All regression are run with CG2 (i.e. the cohort prior to the reform) and with month-of-birth FEs. The 'overall' specification includes year fixed effects, as well. The outcome variables are defined as the number of cases per thousand individuals (births). Dependent mean and the effect size correspond to pre-reform values of the treated group.
...
%For women and men
%\midrule\multicolumn{5}{l}{\emph{Panel B. Women}} \\ 
%  \midrule\multicolumn{5}{l}{\emph{Panel C. Men}} \\ 
%\input{KKH/paper_hospital2_m_DD_overall} 
%\input{KKH/paper_hospital2_m_DD_17-21} \input{KKH/paper_hospital2_m_DD_22-26} \input{KKH/paper_hospital2_m_DD_27-31} \input{KKH/paper_hospital2_m_DD_32-35} 
