...
Behavioral responses with respect to the forcing variable (the birth date of the child) would jeopardize the validity of the identification strategy. Usually, the occurrence of birth can be considered as a random event, given the date of conception. Gestation length is a normally distributed random variable with mean of 40 weeks and 2 weeks standard deviation \citep{Ekberg2013parental}. However, there is reason to doubt the randomness of the event. \newline 
...
\textbf{Analysis carried out on the AMR level}
\begin{align}
...
\begin{figure}[H]\centering
	...
	\begin{minipage}{0.9 \linewidth}
		...
		\textbf{how do I get the gray shading from the original figure in the bottom part?}
	\end{minipage}
\end{figure}
\vspace*{\fill}\clearpage
