...
To further examine the source for the reductions in hospitalizations, we 



Overview figure \ref{fig: DD_across_main chapters}
...
\newpage
\textbf{TABELLEN: Sollen wir evtl die SD rausnehmen und einfach nur alles in Bezug zum mean interpretieren?}
