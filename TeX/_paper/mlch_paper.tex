...
\input{../../analysis/tables/paper/DD_hospital2_overall_agegroup_women_men}
\restoregeometry
...
\begin{table}[H] \centering 
	\begin{threeparttable} \centering \caption{ITT effects on \textbf{hospital admission and main diagnoses chapters}}\label{tab: ITT_across_chapters_per_age_group_total}
...
\newgeometry{left=1cm,right=1cm,top=1cm,bottom=2.5cm} 
\input{../../analysis/tables/paper/DD_d5_overall_agegroup_women_men}
\restoregeometry
...
\input{../../analysis/tables/paper/robustness_hospital2_wo_altDD}
\restoregeometry
...
% THREATS
\bigskip
\section*{Potential Threats to Identification and Validity of the Design}\label{sec:empirical_strategy_threats+validity}
