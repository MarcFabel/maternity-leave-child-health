...
%I perform several sensitivity and placebo test to assess the robustness of my findings. The result of these additional tests are reported in Table \ref{tab: robustness_hospital}. 
