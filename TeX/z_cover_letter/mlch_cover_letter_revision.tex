...
Dear Professor Balsa,

Thank you very much for the opportunity to revise my paper, “Maternity Leave and Children's Health Outcomes in the Long-Term” (Ms. No. JHE\_2020\_401R1), for possible publication in the Journal of Health Economics.

I am very grateful to you and the referees for the detailed reading of my paper, the constructive comments, and helpful suggestions. Having now spent additional time and effort on the paper, I feel that the comments have helped me a lot in further improving it. 

I provide comprehensive point-by-point responses to the comments raised by you and the referees in the enclosed response letter. Here, I would like to stress the following main parts of my revision: 

\begin{itemize}[leftmargin=*]
	\item[-] I have presented new evidence that the parallel trends assumption holds (section 5). 
	\item[-] I have included an extra section in the Appendix discussing potential threats along the whole distribution of birth months (section V.2). In there, I show that seasonal month of birth effects, such as discontinuities from school entry rules, do not pose a threat to the identification scheme.
	\item[-] I have run additional estimations which support the notion that SUTVA holds and spillover effects on older siblings are not an issue in my context (section 5.4).
	\item[-] I have restructured the paper to have a more concise discussion section (section 6), containing the conceptual framework and mechanisms.
\end{itemize}
