	...
	\begin{threeparttable} \centering \caption{ITT effects on \textbf{mental and behavioral disorders (women)}}\label{tab: DD_hopsital2_total}
		{\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} 
			\begin{tabular}{l*{8}{c}}
				...
				\input{paper/include/paper_r_popf_d5_f_DD_overall} \\ \\
				\multicolumn{5}{l}{\emph{Panel B. Age brackets}} \\
				\input{paper/include/paper_r_popf_d5_f_DD_27-29} \input{paper/include/paper_r_popf_d5_f_DD_30-32} \input{paper/include/paper_r_popf_d5_f_DD_33-35} 
				\bottomrule 
		\end{tabular}}
		\begin{tablenotes} 
