 ...
 \begin{table}[H] \centering 
 	...
 	{\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} 
 			\begin{tabular}{l*{6}{c}}
 				...
 				\input{presentation/include/paper_d5_f_DD_overall} \\ \\
 				\multicolumn{5}{l}{\emph{Panel B. Age brackets}} \\
 				\input{paper/include/paper_d5_f_DD_17-21} \input{paper/include/paper_d5_f_DD_22-26} \input{paper/include/paper_d5_f_DD_27-31} \input{paper/include/paper_d5_f_DD_32-35} 
 				\bottomrule 
 		\end{tabular}}
 		\begin{tablenotes} 
