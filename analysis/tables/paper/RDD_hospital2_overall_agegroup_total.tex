 ...
 \begin{threeparttable} \centering \caption{RDD on \textbf{hospital admission (total)}}\label{tab_mlch: RDD_hopsital2_total}
  {\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} 
 	\begin{tabular}{l*{6}{c}}
 		...
 		\input{paper/include/paper_hospital2_RDD_overall} \\ \\
 		\multicolumn{5}{l}{\emph{Panel B. Age brackets}} \\
 		\input{paper/include/paper_hospital2_RDD_17-21} \input{paper/include/paper_hospital2_RDD_22-26} \input{paper/include/paper_hospital2_RDD_27-31} \input{paper/include/paper_hospital2_RDD_32-35} 
 		\bottomrule 
 	\end{tabular}}
 	\begin{tablenotes} 
