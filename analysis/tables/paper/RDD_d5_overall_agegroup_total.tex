...
\begin{table}[H] \centering 
 \begin{threeparttable} \centering \caption{RDD on \textbf{mental \& behavioral disorders (total)}}\label{tab_mlch: RDD_d5_total}
  {\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} 
 	\begin{tabular}{l*{6}{c}}
 		...
 		\input{paper/include/paper_d5_RDD_overall} \\ \\
 		\multicolumn{5}{l}{\emph{Panel B. Age brackets}} \\
 		\input{paper/include/paper_d5_RDD_17-21} \input{paper/include/paper_d5_DD_22-26} \input{paper/include/paper_d5_DD_27-31} \input{paper/include/paper_d5_DD_32-35} 
 		\bottomrule 
 	\end{tabular}}
 	\begin{tablenotes} 
