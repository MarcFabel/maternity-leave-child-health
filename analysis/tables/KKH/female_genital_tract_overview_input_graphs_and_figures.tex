%---------------------------------
% INPUT FOR VARIABLE: female_genital_tract
%---------------------------------
\subsection{female\_genital\_tract}
% RD overview
\begin{landscape}
\begin{figure}[H]
	\centering
	\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_female_genital_tract_overview_panel1}
...
\begin{figure}[H]
	\centering
\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_female_genital_tract_overview_panel2}
...
\includegraphics[width=\linewidth]{lc_female_genital_tract_overview_panel1}
...
\centering
\begin{minipage}{.9\linewidth}
\includegraphics[width=\linewidth]{lc_female_genital_tract_overview_panel2}
...
\begin{figure}[H]%\vspace*{-2cm}
	\centering
	\includegraphics[width=.9\linewidth]{lc_female_genital_tract_overview_panel3}
	\includegraphics[width=.9\linewidth]{lc_female_genital_tract_overview_panel4}
\end{figure}
\begin{figure}[H]
	\centering	
	\includegraphics[width=.97\linewidth]{lc_female_genital_tract_overview_panel5}
	\includegraphics[width=.97\linewidth]{lc_female_genital_tract_overview_panel6}
\end{figure}
%---------------------------------
