...
\begin{figure}[H]
	...
	\includegraphics[width=\linewidth]{rd_d8_overview_panel1}
...
\begin{figure}[H]
	\centering
\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_d8_overview_panel2}
...
\includegraphics[width=\linewidth]{lc_d8_overview_panel1}
...
\centering
\begin{minipage}{.9\linewidth}
\includegraphics[width=\linewidth]{lc_d8_overview_panel2}
...
\begin{figure}[H]%\vspace*{-2cm}
	\centering
	\includegraphics[width=.9\linewidth]{lc_d8_overview_panel3}
	\includegraphics[width=.9\linewidth]{lc_d8_overview_panel4}
\end{figure}
\begin{figure}[H]
	\centering	
	\includegraphics[width=.97\linewidth]{lc_d8_overview_panel5}
	\includegraphics[width=.97\linewidth]{lc_d8_overview_panel6}
\end{figure}
% Life-course TABLE Format
\input{d8_LC_agegroups.tex}
%---------------------------------
% PLACEBO EXERCISES
\newpage
\begin{landscape}
\begin{figure}[H]
	\centering
    \begin{minipage}{.9\linewidth}
	\includegraphics[width=\linewidth]{placebo_graph_d8.pdf}
...
\end{figure}
\end{landscape}
\input{d8_placebo1.tex}
\input{d8_placebo2.tex}
\input{d8_placebo3.tex}
%---------------------------------
% CUMMULATIVE APPROACH
\begin{landscape}
\input{d8_DDRD_cummulapproach.tex}
\end{landscape}
\begin{landscape}
\input{d8_DDRD_cummulapproach_boot.tex}
\end{landscape}
%---------------------------------
\newpage
FEBRUAR CASES:
\input{d8_TG_cases_per_MOB_year.tex}
\input{d8_differenced_cases_per_MOB_year.tex}
