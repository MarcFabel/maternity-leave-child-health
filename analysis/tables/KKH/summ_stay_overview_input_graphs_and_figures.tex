%---------------------------------
% INPUT FOR VARIABLE: summ_stay
%---------------------------------
\subsection{summ\_stay}
% RD overview
\begin{landscape}
\begin{figure}[H]
	\centering
	\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_summ_stay_overview_panel1}
...
\begin{figure}[H]
	\centering
\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_summ_stay_overview_panel2}
...
%---------------------------------
% TABELLEN
\input{summ_stay_DDRD_overview_tfm}
...
\includegraphics[width=\linewidth]{lc_summ_stay_overview_panel1}
...
\centering
\begin{minipage}{.9\linewidth}
\includegraphics[width=\linewidth]{lc_summ_stay_overview_panel2}
...
\begin{figure}[H]%\vspace*{-2cm}
	\centering
	\includegraphics[width=.9\linewidth]{lc_summ_stay_overview_panel3}
	\includegraphics[width=.9\linewidth]{lc_summ_stay_overview_panel4}
\end{figure}
\begin{figure}[H]
	\centering	
	\includegraphics[width=.97\linewidth]{lc_summ_stay_overview_panel5}
	\includegraphics[width=.97\linewidth]{lc_summ_stay_overview_panel6}
\end{figure}
% Life-course TABLE Format
\input{summ_stay_LC_agegroups.tex}
%---------------------------------
% PLACEBO EXERCISES
\newpage
\begin{landscape}
\begin{figure}[H]
	\centering
    \begin{minipage}{.9\linewidth}
	\includegraphics[width=\linewidth]{placebo_graph_summ_stay.pdf}
...
\end{figure}
\end{landscape}
\input{summ_stay_placebo1.tex}
\input{summ_stay_placebo2.tex}
\input{summ_stay_placebo3.tex}
%---------------------------------
% CUMMULATIVE APPROACH
\begin{landscape}
\input{summ_stay_DDRD_cummulapproach.tex}
\end{landscape}
\begin{landscape}
\input{summ_stay_DDRD_cummulapproach_boot.tex}
\end{landscape}
%---------------------------------
\newpage
FEBRUAR CASES:
\input{summ_stay_TG_cases_per_MOB_year.tex}
\input{summ_stay_differenced_cases_per_MOB_year.tex}
