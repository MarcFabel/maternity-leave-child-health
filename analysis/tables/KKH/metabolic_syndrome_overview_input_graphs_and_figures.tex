%---------------------------------
% INPUT FOR VARIABLE: metabolic_syndrome
%---------------------------------
\subsection{metabolic\_syndrome}
% RD overview
\begin{landscape}
\begin{figure}[H]
	\centering
	\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_metabolic_syndrome_overview_panel1}
...
\begin{figure}[H]
	\centering
\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_metabolic_syndrome_overview_panel2}
...
%---------------------------------
% TABELLEN
\input{metabolic_syndrome_DDRD_overview_tfm}
\input{metabolic_syndrome_DDRD_overview_cg}
%---------------------------------
...
\includegraphics[width=\linewidth]{lc_metabolic_syndrome_overview_panel1}
...
\centering
\begin{minipage}{.9\linewidth}
\includegraphics[width=\linewidth]{lc_metabolic_syndrome_overview_panel2}
...
\begin{figure}[H]%\vspace*{-2cm}
	\centering
	\includegraphics[width=.9\linewidth]{lc_metabolic_syndrome_overview_panel3}
	\includegraphics[width=.9\linewidth]{lc_metabolic_syndrome_overview_panel4}
\end{figure}
\begin{figure}[H]
	\centering	
	\includegraphics[width=.97\linewidth]{lc_metabolic_syndrome_overview_panel5}
	\includegraphics[width=.97\linewidth]{lc_metabolic_syndrome_overview_panel6}
\end{figure}
% Life-course TABLE Format
\input{metabolic_syndrome_LC_agegroups.tex}
%---------------------------------
% PLACEBO EXERCISES
\newpage
\begin{landscape}
\begin{figure}[H]
	\centering
    \begin{minipage}{.9\linewidth}
	\includegraphics[width=\linewidth]{placebo_graph_metabolic_syndrome.pdf}
...
\end{figure}
\end{landscape}
\input{metabolic_syndrome_placebo1.tex}
\input{metabolic_syndrome_placebo2.tex}
\input{metabolic_syndrome_placebo3.tex}
%---------------------------------
% CUMMULATIVE APPROACH
\begin{landscape}
\input{metabolic_syndrome_DDRD_cummulapproach.tex}
\end{landscape}
\begin{landscape}
\input{metabolic_syndrome_DDRD_cummulapproach_boot.tex}
\end{landscape}
%---------------------------------
\newpage
FEBRUAR CASES:
\input{metabolic_syndrome_TG_cases_per_MOB_year.tex}
\input{metabolic_syndrome_differenced_cases_per_MOB_year.tex}
