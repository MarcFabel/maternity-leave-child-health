...
\begin{figure}[H]
	...
	\includegraphics[width=\linewidth]{rd_joints_overview_panel1}
...
\begin{figure}[H]
	\centering
\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_joints_overview_panel2}
...
%---------------------------------
% TABELLEN
\input{joints_DDRD_overview_tfm}
...
\includegraphics[width=\linewidth]{lc_joints_overview_panel1}
...
\centering
\begin{minipage}{.9\linewidth}
\includegraphics[width=\linewidth]{lc_joints_overview_panel2}
...
\begin{figure}[H]%\vspace*{-2cm}
	\centering
	\includegraphics[width=.9\linewidth]{lc_joints_overview_panel3}
	\includegraphics[width=.9\linewidth]{lc_joints_overview_panel4}
\end{figure}
\begin{figure}[H]
	\centering	
	\includegraphics[width=.97\linewidth]{lc_joints_overview_panel5}
	\includegraphics[width=.97\linewidth]{lc_joints_overview_panel6}
\end{figure}
% Life-course TABLE Format
%\input{joints_LC_agegroups.tex}
%---------------------------------
% PLACEBO EXERCISES
\begin{figure}[H]%\vspace*{-2cm}
	\centering
	\includegraphics[width=.9\linewidth]{placebo_graph_joints.pdf}
\end{figure}
\input{joints_placebo1.tex}
\input{joints_placebo2.tex}
\input{joints_placebo3.tex}
%---------------------------------
% CUMMULATIVE APPROACH
\input{joints_DDRD_cummulapproach.tex}
%\input{joints_DDRD_cummulapproach_boot.tex}
%---------------------------------
FEBRUAR CASES:
\input{joints_TG_cases_per_MOB_year.tex}
\input{joints_differenced_cases_per_MOB_year.tex}
