%---------------------------------
% INPUT FOR VARIABLE: drug_abuse
%---------------------------------
\subsection{drug\_abuse}
% RD overview
\begin{landscape}
\begin{figure}[H]
	\centering
	\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_drug_abuse_overview_panel1}
...
\begin{figure}[H]
	\centering
\begin{minipage}{.95\linewidth}
	\includegraphics[width=\linewidth]{rd_drug_abuse_overview_panel2}
...
%---------------------------------
% TABELLEN
\input{drug_abuse_DDRD_overview_tfm}
\input{drug_abuse_DDRD_overview_cg}
%---------------------------------
...
\includegraphics[width=\linewidth]{lc_drug_abuse_overview_panel1}
...
\centering
\begin{minipage}{.9\linewidth}
\includegraphics[width=\linewidth]{lc_drug_abuse_overview_panel2}
...
\begin{figure}[H]%\vspace*{-2cm}
	\centering
	\includegraphics[width=.9\linewidth]{lc_drug_abuse_overview_panel3}
	\includegraphics[width=.9\linewidth]{lc_drug_abuse_overview_panel4}
\end{figure}
\begin{figure}[H]
	\centering	
	\includegraphics[width=.97\linewidth]{lc_drug_abuse_overview_panel5}
	\includegraphics[width=.97\linewidth]{lc_drug_abuse_overview_panel6}
\end{figure}
% Life-course TABLE Format
\input{drug_abuse_LC_agegroups.tex}
%---------------------------------
% PLACEBO EXERCISES
\newpage
\begin{landscape}
\begin{figure}[H]
	\centering
    \begin{minipage}{.9\linewidth}
	\includegraphics[width=\linewidth]{placebo_graph_drug_abuse.pdf}
...
\end{figure}
\end{landscape}
\input{drug_abuse_placebo1.tex}
\input{drug_abuse_placebo2.tex}
\input{drug_abuse_placebo3.tex}
%---------------------------------
% CUMMULATIVE APPROACH
\begin{landscape}
\input{drug_abuse_DDRD_cummulapproach.tex}
\end{landscape}
\begin{landscape}
\input{drug_abuse_DDRD_cummulapproach_boot.tex}
\end{landscape}
%---------------------------------
\newpage
FEBRUAR CASES:
\input{drug_abuse_TG_cases_per_MOB_year.tex}
\input{drug_abuse_differenced_cases_per_MOB_year.tex}
