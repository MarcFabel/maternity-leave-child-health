...
foreach var of varlist hospital2 {
capture drop r_popf_hospital2*
...
// 1.a) DDRD - different bandwidths (month of birth)
	...
	// TOTAL
		eststo clear 
		*absolute numbers
		DDRD_sclrs a1 `1'`j'   	"i.MOB" "if $C2 & $M1 [w = _002_pop]"
		DDRD_sclrs a2 `1'`j'   	"i.MOB" "if $C2 & $M2 [w = _002_pop]"
		DDRD_sclrs a3 `1'`j'   	"i.MOB" "if $C2 & $M3 [w = _002_pop]"
		DDRD_sclrs a4 `1'`j'   	"i.MOB" "if $C2 & $M4 [w = _002_pop]"
		DDRD_sclrs a5 `1'`j'   	"i.MOB" "if $C2 & $M5 [w = _002_pop]"
		DDRD_sclrs a6 `1'`j'   	"i.MOB" "if $C2 [w = _002_pop]"
		DDRD_sclrs a7 `1'`j'   	"i.MOB" "if $C2 & $MD [w = _002_pop]"
		...
		*ratio population
		DDRD_sclrs c1 r_popf_`1'`j'   "i.MOB" "if $C2 & $M1 [w = _002_pop]"
		DDRD_sclrs c2 r_popf_`1'`j'   "i.MOB" "if $C2 & $M2 [w = _002_pop]"
		DDRD_sclrs c3 r_popf_`1'`j'   "i.MOB" "if $C2 & $M3 [w = _002_pop]"
		DDRD_sclrs c4 r_popf_`1'`j'   "i.MOB" "if $C2 & $M4 [w = _002_pop]"
		DDRD_sclrs c5 r_popf_`1'`j'   "i.MOB" "if $C2 & $M5 [w = _002_pop]"
		DDRD_sclrs c6 r_popf_`1'`j'   "i.MOB" "if $C2 [w = _002_pop]"
		DDRD_sclrs c7 r_popf_`1'`j'   "i.MOB" "if $C2 & $MD [w = _002_pop]"
