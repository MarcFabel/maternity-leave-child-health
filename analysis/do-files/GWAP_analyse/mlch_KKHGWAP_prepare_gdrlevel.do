...
*******************************************************************************/
 ...
 use "$temp/KKH_gdr_level_raw", clear
...
local totals 
	...
	death hospital hospital2 patients Summ_stay Sum_surgery;
#delim cr
...
foreach var of varlist `totals' {
	...
	qui generate r_fert_`var'_m = `var'_m*1000 / fertm_GDR
}
////////////////////////////////////////////////////////////////////////////////////////
...
// Saving
	...
	qui save "$temp/KKH_final_gdrlevel_extended", replace
	keep if control !=.		// wirklich nur control groups 123 & TG
	qui save "$temp/KKH_final_gdr_level", replace
