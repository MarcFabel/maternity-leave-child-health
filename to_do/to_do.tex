...
\bigskip
\textbf{What to do at the statistical office}
\begin{enumerate}
	\item LMR level: once with and without i.amr
	\item (lenght of stay conditional on diagnosis chapter)
\end{enumerate}

\textbf{What to check:}
\begin{itemize}
	\item regressions with 2M bins
	\item sensitivity without Februar Kinder
\end{itemize}
