...
\begin{itemize}
\item[-] \textbf{FLFP in 1979:}\newline Sefan Wöhrmüller Daten oder shares aus MZ ziehen (Marc Piopiunik)
\end{itemize}
...
\item \textbf{robustness section:}\newline
ratios mit den Geburtszaheln im Nenner (DESTATIS): $\frac{\#\ of diagnosis}{\#\ people born_m}$
